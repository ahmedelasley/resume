...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-dashboard-header-right">
            <div>
                <label class="tx-13 text-center">No. Experiences</label>
                <h5 class="tx-13 text-center">{{\App\Experience::count()}}</h5>
            </div>
                ...
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <a class="modal-effect btn btn-sm btn-primary " data-effect="effect-scale" data-toggle="modal" href="#add"><i class="las la-plus"></i> Add Experience</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example1" class="table key-buttons text-md-nowrap text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">Title Job</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($experiences as $experience)
                                        ...
                                        <tr>
                                            <td>{{$i}}</td>
                                            <td><a class="dropdown-item btn btn-success" data-toggle="modal" href="#view" title="View">{{$experience->title_job}}</a></td>
                                            <td>{{ date_format(date_create($experience->start_date),'M Y') }}</td>
                                            <td>{{!empty($experience->end_date) ? date_format(date_create($experience->end_date),'M Y') : "Present"}}</td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu tx-13">
                                                        <a class="dropdown-item btn btn-success" data-id="{{ $experience->id }}" data-toggle="modal" href="#edit" title="Edit"><i class="text-success las la-pen"></i> Edit</a>
                                                        <a class="dropdown-item btn text-danger" data-id="{{ $experience->id }}" data-toggle="modal" href="#delete" title="Delete"><i class="text-danger las la-trash"></i> Delete</a>
                                                    </div>
                                                </div>
